  ...
  return (
    <div className="relative w-full" ref={containerRef}>
      ...
      <button
        ...
        className="flex w-full items-center justify-between rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-left transition-colors hover:border-slate-300 focus:outline-none focus:ring-2 focus:ring-slate-200"
      >
        <div className="flex min-w-0 items-center gap-2">
          ...
          {value ? (
            <div className="flex min-w-0 items-center gap-2">
              ...
              <span className="hidden text-xs text-slate-400 sm:inline">{displayAD}</span>
            </div>
          ) : (
      ...
      {/* Dropdown panel */}
      {isOpen && (
        <div className="absolute left-0 right-0 top-full z-50 mt-1 overflow-hidden rounded-lg border border-slate-200 bg-white shadow-md">
            ...
            <div className="flex items-center gap-2">
              <div className="relative flex items-center">
                <select
                  ...
                  className="cursor-pointer appearance-none border-none bg-transparent pr-5 text-sm font-medium text-slate-900 focus:outline-none"
                >
          ...
          <div className="p-3">
            <div className="grid grid-cols-8 gap-0.5">
              {Array.from({ length: daysInMonth }, (_, i) => i + 1).map((day) => {
                ...
                const isToday =
                  bsYear === today.year && bsMonth === today.month && day === today.day
          ...
          <div className="space-y-2 px-3 pb-3">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex-1 rounded-lg bg-slate-900 py-2 text-xs font-medium text-white transition-colors hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-40"
              >
                Confirm
              </button>
            </div>
