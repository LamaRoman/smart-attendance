...
const s = StyleSheet.create({
  ...
  label: { fontSize: 13, fontWeight: '700', color: Colors.slate700, marginBottom: 8, marginTop: 16 },
  typeGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  typeChip: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 12, paddingVertical: 10, borderRadius: 10, backgroundColor: Colors.slate100, borderWidth: 1, borderColor: Colors.slate200, width: '48%' },
  typeChipSel: { backgroundColor: '#E2E8F0', borderColor: Colors.slate900 },
  typeIcon: { fontSize: 16 },
  typeChipText: { fontSize: 12, fontWeight: '600', color: Colors.slate700, flex: 1 },
  typeChipTextSel: { color: Colors.slate900 },
  checkmark: { fontSize: 12, color: Colors.slate900, fontWeight: '700' },
  dateBtn: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: Colors.white, borderRadius: 10, borderWidth: 1, borderColor: Colors.slate200, paddingHorizontal: 14, paddingVertical: 14 },
  dateBtnText: { fontSize: 15, fontWeight: '600', color: Colors.slate900 },
  dateBtnIcon: { fontSize: 18 },
  durationBox: { marginTop: 10, backgroundColor: Colors.slate50, borderRadius: 8, padding: 12, borderWidth: 1, borderColor: Colors.slate200, gap: 4 },
  durationText: { fontSize: 13, fontWeight: '600', color: Colors.slate700 },
  balanceHint: { fontSize: 12, fontWeight: '500' },
  balanceOk: { color: Colors.success },
  balanceLow: { color: Colors.warning },
  reasonInput: { backgroundColor: Colors.white, borderRadius: 10, borderWidth: 1, borderColor: Colors.slate200, paddingHorizontal: 14, paddingVertical: 12, fontSize: 15, color: Colors.slate900, minHeight: 100 },
  btnRow: { flexDirection: 'row', gap: 12, marginTop: 24 },
  cancelBtn: { flex: 1, paddingVertical: 14, borderRadius: 10, borderWidth: 1, borderColor: Colors.slate200, alignItems: 'center' },
  cancelBtnText: { fontSize: 14, fontWeight: '600', color: Colors.slate600 },
  submitBtn: { flex: 1, paddingVertical: 14, borderRadius: 10, backgroundColor: Colors.slate900, alignItems: 'center' },
  ...
  arrow: { fontSize: 28, color: Colors.slate900 },
  ymText: { fontSize: 16, fontWeight: '700', color: Colors.slate900, width: 160, textAlign: 'center' },
  monthChip: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16, backgroundColor: Colors.slate100, marginRight: 6 },
  monthChipSel: { backgroundColor: Colors.slate900 },
  monthChipText: { fontSize: 12, fontWeight: '600', color: Colors.slate700 },
  monthChipTextSel: { color: Colors.white },
  dayGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginBottom: 16 },
  dayCell: { width: 40, height: 40, borderRadius: 8, backgroundColor: Colors.slate100, alignItems: 'center', justifyContent: 'center' },
  dayCellSel: { backgroundColor: Colors.slate900 },
  dayCellOff: { opacity: 0.3 },
  dayCellText: { fontSize: 13, fontWeight: '600', color: Colors.slate700 },
  dayCellTextSel: { color: Colors.white },
  dayCellTextOff: { color: Colors.slate400 },
  selectBtn: { backgroundColor: Colors.slate900, borderRadius: 10, paddingVertical: 14, alignItems: 'center' },
